            ...
            <div class="right_col right_col_full_width">
                <div class="listing_row">
                    ...
                    @if(isset($userCVs) && count($userCVs) > 0)
                        @forelse($userCVs as $userCV)

                        <div class="jobs_apply_block clearfix">
                            <div class="inner_block">
                                <h3>
                                    <a href="{!! URL::route('download-cv', ['id' => $userCV->id]) !!}">
                                        {!! $userCV->name !!}
                                    </a>
                                </h3>
                                <p>{{ strip_tags($userCV->description) }}</p>
                            </div>
                            <div class="date_block clearfix">
                                <div class="inner_block clearfix">
                                    <div class="date_text">
                                        <img src="{{ asset('images/calendar_icon.png') }}" alt=""><span style="font-family:Serif">CV Upload At : {{ $userCV->created_at->toFormattedDateString() }}</span>
                                    </div>
                                    <div class="button">
                                        @if(isset($userCV->id))
                                            ...
                                            <a class="cancelApplication" href="{!! URL::route('destroyCVbyClient', ['id' => $userCV->id]) !!}" >
                                                Delete
                                            </a>
                                        @endif
