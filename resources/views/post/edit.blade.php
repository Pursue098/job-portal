...
@section('content')
    ...
    <div class="row">
        {!! Form::model($activity, [ 'url' => URL::route('v1.client.post.update', ['id' => $activity->id])] )  !!}
        {{ Form::hidden('_method', 'PUT') }}
        <div class="col-xs-12">

            <div class="form-group">
                <div class="col-xs-12" style="margin-bottom: 10px">
                    {!! Form::label('name', 'Activity Title', array('class'=>'col-sm-2 control-label')) !!}
                    <div class="col-sm-6">
                        {!! Form::text('name',  $activity->name, array('id' => 'title', 'class' => 'form-control', 'placeholder'   => 'Activity name','value' => '','required' => 'required')) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-xs-12" style="margin-bottom: 10px">
                    ...
                    <div class="col-sm-6">
                        {!! Form::text('description', $activity->description, array('id' => 'description', 'class' => 'form-control', 'placeholder'   => 'Activity description','value' => '')) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-xs-12" style="margin-bottom: 10px">
                    ...
                    <div class="col-sm-6">
                        {!! Form::text('location', $activity->location, array('id' => 'location', 'class' => 'form-control', 'placeholder'   => 'Your location','value' => '')) !!}
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-12" style="margin-bottom: 10px">
                    ...
                    <div class="col-sm-6">
                        @if(isset($activity->image))
                            {{ Form::hidden('invisible', $activity->image, array('id' => 'p_invisible_image')) }}
                            {{ Form::image(url('assets/images/event/'.$activity->image), 'p_old_image', array("class"=>"p_old_image1", "style" => "width: 50px; height: 50px; margin-left:20px; border: 1px solid black;")) }}
                            <br><br>
    ...
    <script>
        ...
        (function($) {
            ...
            $('#fileinput').on('change', function (event, files, label) {
                ...
                alert('azam')
                $('.p_old_image1').attr('src', '{{env('APP_URL')}}'+'assets/images/staticImage/'+file_name);
