...
@section('content')
    ...
    <div class="row">
    {!! Form::open(array('route' => 'v1.client.event.store', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form')) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            {!! Form::text('description', null, array('id' => 'description', 'class' => 'form-control', 'placeholder'   => 'Event description','value' => '')) !!}
        </div>
    </div>
