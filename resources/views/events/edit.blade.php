...
@section('content')
    ...
    <div class="row">
        {!! Form::model($event, [ 'url' => URL::route('v1.client.event.update', ['id' => $event->id])] )  !!}
        ...
        <div class="col-xs-12">
            ...
            <div class="form-group">
                <div class="col-xs-12" style="margin-bottom: 10px">
                    ...
                    <div class="col-sm-6">
                        {!! Form::text('description', $event->description, array('id' => 'description', 'class' => 'form-control', 'placeholder'   => 'Event description','value' => '')) !!}
                    </div>
                </div>
            </div>
