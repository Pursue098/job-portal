                    ...
                    @if(count($event) > 0)
                        ...
                        <div class="jobs_apply_detail_block clearfix">
                            <div class="detail_block_outer">
                                ...
                                @if(isset($event->image))
                                    {{ Form::image(url('assets/images/event/'.$event->image), 'e_image', array("class"=>"e_image", "style"=>"width:662px; height:150px;")) }}
                                @endif
                                <div class="row">
                                    <div class="col-xs-12" style="margin-top: 10px;">
                                        @if($event->getEventOwnerUser($event->user_id) != false)
                                            ...
                                            @foreach ($event->posts as $post)
                                                ...
                                                @if(isset($post) && count($post) > 0)
                                                    <div class="row">
                                                        <a href="">
                                                            <div class="col-xs-2">
                                                                {{ Form::image(url('assets/images/post/'.$post->images->first()->name), 'e_image', array("class"=>"e_image post-image", "style"=>"width:50px; height:50px;")) }}
                                                            </div>
                                                        </a>
                                                            ...
                                                            <p class="post-text">
                                                                <span class="post-user">
                                                                    ...
                                                                    @if($post->getPostUser($post->id) != false)
                                                                        ...
                                                                        <a href="">
                                                                            {{$post->getPostUser($post->id)->user_profile->first()->first_name}}
                                                                            {{$post->getPostUser($post->id)->user_profile->first()->last_name}}
                                                                        </a>
                                                                ...
                                                                <span class="post-text-date">{{$post->created_at}}</span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                @endif
