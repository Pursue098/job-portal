                            ...
                            <div class="row">
                                <div class="inner_block">
                                    <div class="inner_left_block">
                                        ...
                                        <h3>
                                            <a href="{!! URL::route('event.show', ['id' => $event->id]) !!}">
                                                {!! $event->name !!}
                                            </a>
                                        </h3>
                                    ...
                                    <div class="inner_right_block">
                                        @if(isset($event->image))
                                            {{ Form::image(url('assets/images/event/'.$event->image), 'e_image', array("class"=>"e_image")) }}
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="date_block clearfix">
                                    <div class="inner_block clearfix">
                                        <div class="date_text">
                                            <img src="{{ asset('images/calendar_icon.png') }}" alt="">{{ $event->created_at->toFormattedDateString() }}
                                        </div>
                                        <div class="date_text">
                                        ...
                                        <div class="button">
                                            ...
                                            @if(isset($event->user))
                                                @if(count($event->user) > 0)
                                                    ...
                                                    @if($event->getEventOperation($event->id) !== false)

                                                        @foreach ($event->getEventOperation($event->id) as $index => $value)

                                                            <a href="{!! URL::route('event.operation', ['e_id' => $event->id ,'op_key' => $index]) !!}" style="margin-left: 30px;">
                                                                {!! $value !!}
                                                            </a>
                                                        @endforeach

                                                        @if($event->getPosts($event->id) == true)
                                                            <a href="{!! URL::route('post.show', ['id' => $event->id]) !!}" style="margin-left: 20px;">
                                                                Its Post
                                                            </a>
                                                        @endif
                                                    @elseif($event->getEventOperation($event->id) === false)
